...
* type.coding contains tasmc 0..1 and sct 1..1
...
* type.coding[sct].system 1..1
* type.coding[sct].system = $sct (exactly)
* type.coding[sct].code 1..1
* type.coding[sct].display 1..1
* type.coding[sct] from $il-core-specimen-type (extensible) // ask daniel if this is valid 16/9/24
