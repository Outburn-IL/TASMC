...
בקשת התחייבות + מענה של התחייבות מאושרת, כולל מספר התחייבות
בקשת התחייבות + מענה של התחייבות מאושרת ללא מספר / התחייבות לא מאושרת / כשל / המתנה
דגימת סטאטוס בקשה + מענה אשר כולל מספר התחייבות
ביטול בקשת התחייבות + מענה
