...
## דוגמה: ספירת דם ותפקודי כליה - פאנל ובדיקות בדידות

### תיאור

דוגמה זו מציגה תרחיש נפוץ בו הזמנה מעבדתית אחת כוללת **בדיקות בפאנל וגם בדיקות בדידות**. המקרה כולל פאנל CBC (ספירת דם) עם שתי בדיקות (WBC ו-PLT), לצד בדיקת eGFR עצמאית לבדיקת תפקוד כליות. זהו דוגמה קלאסית למבנה מעורב (mixed scenario) המשקף את המציאות הקלינית בה לא כל הבדיקות מאורגנות בפאנלים.
...
* **Specimen (×2)** - שתי דגימות במבחנות שונות (סגול ל-CBC, אפור ל-eGFR)
...
![מבנה קשרי משאבים - פאנל ובדיקות בדידות](ספירת_דם_ותפקודי_כליה.jpg)
...
* מערכות EMR המציגות תוצאות מעבדה - חשוב להבחין בין פאנלים לבדיקות בדידות
* אינטגרציה עם מערכות הזמנות (CPOE)
* דוחות מעבדה המציגים קיבוץ לוגי של בדיקות לצד בדיקות בדידות
