// Profile: TasmcObservationCoreLab
// Parent: ILCoreObservationLab
// Id: tasmc-observation-core-lab
// Title: "Sourasky Lab Core Results Profile"
// Description: "tasmc Observation Core Lab profile, based on ILcoreObservationLab"
// * id 1..1
